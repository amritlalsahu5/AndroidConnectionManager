...
/**
 * Interface that defines the request lifecycle used by HttpClient
...
public interface RequestHandler {
     ...
     * @throws IOException
     */
	public void writeStream(DataOutputStream out, byte[] content, int offset,int count) throws IOException;
     ...
     * @throws IOException
     */
    void writeStream(OutputStream out, byte[] content, int offset, int size) throws IOException;
